...
/**
 * * ListaAlunni4 è una classe che rappresenta la lista degli alunni della classe "Quarta" con i rispettivi record. La classe
...
public class ListaAlunni4 extends AppCompatActivity {
    ...
    private void setTextLista() {
        ...
        customAdapter=new AlunniListAdapter(ListaAlunni4.this, R.layout.lista_row, alunni);
