...
/**
 * ListaAlunni3 è una classe che rappresenta la lista degli alunni della classe "Terza" con i rispettivi record. La classe
...
public class ListaAlunni3 extends AppCompatActivity {
    ...
    private void setTextLista() {
        ...
        customAdapter=new AlunniListAdapter(ListaAlunni3.this, R.layout.lista_row, alunni);
