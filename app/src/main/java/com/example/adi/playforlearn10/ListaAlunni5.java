...
/**
 * ListaAlunni5 è una classe che rappresenta la lista degli alunni della classe "Quinta" con i rispettivi record. La classe
...
public class ListaAlunni5 extends AppCompatActivity {
    ...
    private void setTextLista() {
        ...
        customAdapter=new AlunniListAdapter(ListaAlunni5.this, R.layout.lista_row, alunni);
        ...
        new AsyncTask<Object, Object, Object>() {
            ...
            protected Object doInBackground(Object... params) {
                ...
                try {
                    ...
                    int porta = 80;
                    String nomeFile = "webservice/lista5.php";
